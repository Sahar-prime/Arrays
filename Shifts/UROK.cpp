//Есть массив из 10 элементов, проинициализированный при объявлении значениями 0, 1, 2, .... 9. Необходимо найти в этом массиве повторяющиеся элементы, вывести на экран и вывести кол-во повторения для каждого такого значения
#include <iostream>
using namespace std;
